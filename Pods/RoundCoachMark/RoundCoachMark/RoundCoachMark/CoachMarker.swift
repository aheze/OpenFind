...
public class CoachMarker {
    ...
    public func resetMarks(completion: @escaping () -> Void) {
        ...
        marks.removeAll()
        nextMarkIndex = 0
        DispatchQueue.main.async { NotificationCenter.default.post(name: Events.CoachMarkerMarksRequest, object: self) }
    }
    ...
    public var defaultInfoViewTitleColor: UIColor = .white {
        didSet { currentInfoView?.setTitleStyle(font: defaultInfoViewTitleFont, color: defaultInfoViewTitleColor) }
    }

    public var defaultInfoViewTextColor: UIColor = .white {
        didSet { currentInfoView?.setTitleStyle(font: defaultInfoViewTitleFont, color: defaultInfoViewTitleColor) }
    }
...
public extension CoachMarker {
    static func cycleAllMarksOnce(in marker: CoachMarker) -> Bool {
