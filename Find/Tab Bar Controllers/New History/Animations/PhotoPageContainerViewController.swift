...
//    var findModels = [FindModel]() /// when searching
//    
//    
...
//        if cameFromFind {
//            
//            let findPhoto = self.findModels[self.currentIndex]
//            vc.findPhoto = findPhoto
//            
...
////            vc.highlights = findPhoto.model.components
...
////        var urlString = URL(string: "")
//        if cameFromFind {
//            let model = self.findPhotos[self.currentIndex - 1]
////            let filePath = model.photo.filePath
//            
////            urlString = folderURL.appendingPathComponent(filePath)
//            vc.matchToColors = matchToColors
